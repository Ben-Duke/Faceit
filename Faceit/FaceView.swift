...
//  Facit
//
//  Created by Ben Duke on 15/05/17.
...
class FaceView: UIView {
    ...
    private func pathForEye(_ eye: Eye) -> UIBezierPath{
        ...
        if eyesOpen{ path = UIBezierPath(arcCenter: eyeCenter, radius: eyeRadius, startAngle: 0, endAngle: CGFloat.pi * 2, clockwise: true)
        }else{
            path = UIBezierPath()
    ...
    private func pathForMouth() -> UIBezierPath{
        let mouthWidth = skullRadius / Ratios.skullRadiusToEyeMonthWidth
        let mouthHeight = skullRadius / Ratios.skullRadiusToEyeMonthHeight
